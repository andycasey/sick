...
% [TODO] "Experiment" with proposal widths.
...
% Discuss precise infererence of ln(f_blue) -- not representative of real world data.

% Confident that the machinery works, allows extension to include other noise models and telluric absorption or resolve of binary systems?
...
% DISCUSS DIFFERENCE IN TRUTH-INFERRED VALUES
 
% DISCUSS THE INCLUSION OF TELLURIC MODELLING
