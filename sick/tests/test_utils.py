...
def test_default_output_format():
    ...
    assert utils.default_output_prefix(["foobar/moocow", "foobar/moowow"]) == "moo"
    assert utils.default_output_prefix(["foobar/moocow.fits"]) == "moocow"
    assert utils.default_output_prefix("") == "sick"
    assert utils.default_output_prefix(["", ""]) == "sick"
    assert utils.default_output_prefix(["moobar/a", "moobar/b"]) == "sick"
